 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "0442f17c-598c-4fa9-a555-b4699ba98926",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Enter a password to test:  penis\n"
     ]
    },
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "=== PASSWORD REPORT ===\n",
      "Score: 0/17\n",
      "This password is a COMMON or BREACHED password. Change it NOW!\n",
      "\n",
      "Issues:\n",
      "- Password is too short (minimum: 8, recommended: 12+).\n",
      ...
      "- Password is in a known list of common/breached passwords.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "id": "4aa7e873-ca26-4949-ba62-7f090a60e37e",
   "metadata": {},
   "outputs": [],
   "source": []
  }
